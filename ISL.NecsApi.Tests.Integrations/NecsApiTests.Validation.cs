...
namespace ISL.NecsApi.Tests.Integrations
{
    public partial class NecsProviderTests
    {
        ...
        [Theory(DisplayName = "Validation - 2.13 - Required on all string fields")]
        [InlineData(null)]
        [InlineData("")]
        [InlineData(" ")]
        [InlineData("   ")]
        ...
        [InlineData("\f")]
        [InlineData(" \t\n\r\v\f")]
        public async Task ShouldThrowValidationErrorWhenPropsIsInvalidAsync(string invalidText)
        {
            // Given
            var expectedErrors = new Dictionary<string, string[]>
            {
